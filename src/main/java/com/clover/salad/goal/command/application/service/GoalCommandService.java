...
public interface GoalCommandService {
	void registerGoal(List<GoalDTO> goalList, String employeeCode) throws Exception;
	
	void changeGoal(List<GoalDTO> goalList, String employeeCode) throws Exception;
